...
o = s:option(Flag, "notify_recover", translate("恢复通知"))
o.default = "0"
o.rmempty = false
o.description = translate("节点检测失败 → 切换节点 → 恢复正常时发送通知")

o = s:option(Flag, "notify_allfail", translate("全部失败通知"))
o.default = "0"
o.rmempty = false
o.description = translate("达到最大尝试次数失败时发送通知")
...
local log_view = s:option(TextValue, "_logview", "")
